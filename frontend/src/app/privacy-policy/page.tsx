        ...
        <div className="relative bg-white p-8 shadow-lg px-6 sm:px-10 md:px-20">
          ...
          <div className="prose max-w-none">
            <p className="text-lg mb-6">
              Sopra Steria er ansvarlig for behandlingen av personopplysninger i forbindelse med den interne konferansen Bytefest. 
              Vi behandler personopplysninger i samsvar med EUs personvernforordning (GDPR) (2016/679) 
              og benytter berettiget interesse som behandlingsgrunnlag for innsamling og bruk av personopplysninger 
              for selve eventet, og samtykke for innsamling av diettopplysninger.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">1. Hvem vi er</h2>
            <p className="text-lg mb-6">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">2. Når vi samler inn personopplysninger</h2>
            <p className="text-lg mb-6">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">3. Hvilke personopplysninger vi samler inn</h2>
            ...
            <p className="text-lg mb-6">
              Dersom du registrerer et foredrag, vil følgende informasjon lagres, 
              og de som blir valgt ut til å holde foredrag får følgende informasjon publisert på nettsiden:
            </p>
            <ul className="list-disc pl-6 mb-6 text-lg">
              <li>Navn</li>
              <li>E-postadresse</li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">4. Behandlingsgrunnlag og hvordan vi bruker personopplysninger</h2>
            <p className="text-lg mb-6">
              Vi behandler personopplysninger basert på berettiget interesse, 
              da Bytefest er en intern konferanse for ansatte i Sopra Steria, 
              og registrering, administrasjon og gjennomføring av arrangementet krever behandling av personopplysninger.
            </p>
            <p className="text-lg mb-4">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">5. Lagring og sletting av personopplysninger</h2>
            <p className="text-lg mb-6">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">6. Deling av opplysninger</h2>
            <ul className="list-disc pl-6 mb-6 text-lg">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">7. Dine rettigheter</h2>
            <p className="text-lg mb-6">
              Du har rett til å:
            </p>
            <ul className="list-disc pl-6 mb-6 text-lg">
            ...
            <p className="text-lg mb-6">
              For informasjon om dine rettigheter og eventuell klage på behandling av personopplysninger, 
              se Sopra Steria sin personvernerklæring for ansatte.
            </p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">8. Informasjonskapsler (Cookies)</h2>
            <p className="text-lg mb-6">
              Nettsiden bruker kun nødvendige informasjonskapsler for SSO-pålogging.
            </p>

            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">9. Sikkerhet</h2>
            <p className="text-lg mb-6">
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4 iceland">10. Endringer i personvernerklæringen</h2>
            <p className="text-lg mb-6">
              Vi kan oppdatere denne personvernerklæringen ved behov. 
              Endringer publiseres på nettsiden, og vesentlige endringer varsles via e-post.
            </p>
          </div>
        </div>
      </div>
